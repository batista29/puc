...
SELECT NOME FROM TB_CLIENTES ORDER BY NOME ASC;

SELECT PRODUTO FROM TB_PRODUTOS ORDER BY PRODUTO DESC;

SELECT PRODUTO FROM TB_PRODUTOS WHERE PRODUTO = 1040107;

SELECT * FROM TB_PRODUTOS WHERE SABOR = 'Melancia'; 

UPDATE TB_PRODUTOS SET SABOR = 'Citrico' WHERE SABOR = 'Limao';

SELECT COUNT(*) FROM TB_CLIENTES WHERE IDADE = 22;
SELECT COUNT(*) FROM TB_CLIENTES WHERE IDADE > 22;
SELECT COUNT(*) FROM TB_CLIENTES WHERE IDADE < 22;
SELECT COUNT(*) FROM TB_CLIENTES WHERE IDADE <> 22;
...
SELECT * FROM TB_CLIENTES WHERE DATA_NASCIMENTO = '25/03/1992';

SELECT * FROM TB_PRODUTOS WHERE PRECO_LISTA < 16.00 AND SABOR = 'Laranja';

SELECT * FROM TB_CLIENTES WHERE NOME LIKE 'S%';
SELECT * FROM TB_CLIENTES WHERE NOME LIKE '%W%';